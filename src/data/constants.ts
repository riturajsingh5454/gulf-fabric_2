...
export const PRODUCTS: Product[] = [
  ...
  { id: 'p-7', title: 'Resort Wave Chutes', category: 'Play Systems', description: 'Glossy FRP water slides engineered for extreme weather and high-traffic use.', imageUrl: '/img-7.jpeg' },
  { id: 'p-8', title: 'Enclosed Spiral Tube', category: 'Play Systems', description: 'Precision-molded spiral slides for indoor amusement parks and mall play zones.', imageUrl: '/img-8.jpeg' },
  { id: 'p-18', title: 'Kids Car Carousel', category: 'Play Systems', description: 'Interactive carousel with colorful car-themed seating for toddlers.', imageUrl: '/img-18.jpeg' },
  { id: 'p-19', title: 'Carousel Structural Frame', category: 'Play Systems', description: 'Heavy-duty steel carousel frame designed for high-capacity amusement rides.', imageUrl: '/img-19.jpeg' },
  { id: 'p-20', title: 'Olympic Water Slide Complex', category: 'Play Systems', description: 'Multi-lane racing slide system with integrated water management plumbing.', imageUrl: '/img-20.jpeg' },
  { id: 'p-21', title: 'Express Mall Train', category: 'Play Systems', description: 'LED-integrated trackless passenger train system with premium hand-finished FRP cabins.', imageUrl: '/img-21.jpeg' },
  { id: 'p-25', title: 'Professional Trampoline', category: 'Play Systems', description: 'High-bounce safety-enclosed trampoline for recreation centers.', imageUrl: '/img-25.jpeg' },
